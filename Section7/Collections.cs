...
└───┴───┴───┘
                ...
                dynamic currentStatus = TicTacToeChecker(board);
...
└───┴───┴───┘
        ...
        public dynamic TicTacToeChecker(dynamic[,] board)
        {
            // int sum = 0;
        ...
        public void ParamsKeyWord(params string[] sentence)
        {
         ...
         public void ListItems(params int[] args)
        {
         ...
         public int LowestNumber(params int[] numbers)
        {
